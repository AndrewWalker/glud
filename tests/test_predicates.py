...
class PredicateTests(BaseGludTest):
    ...
    def test_find_classes(self):
        ...
        self.assertEquals(2, toolz.count(it))
    ...
    def test_can_ignore_forward_declaration(self):
        ...
        self.assertEquals(1, toolz.count(classes))
    ...
    def test_template_class(self):
        ...
        self.assertEquals(0, toolz.count(classes))
    ...
    def test_find_nested_classes(self):
        ...
        self.assertEquals(2, toolz.count(classes))
    ...
    def test_access_specifiers(self):
        ...
        def cnt_match(f, root):
            return toolz.count(glud.walk(all_fn([is_method, f]), root))
    ...
    def test_haslocation(self):
        s = 'void f();'
        root = self._parse(s, options=TranslationUnit.PARSE_DETAILED_PROCESSING_RECORD)
    ...
    def test_function(self):
        ...
        self.assertEquals(1, toolz.count(fs))
